...
export const VariantCreate = ({
  ...
  // Helper: build payload to ADD variants to an existing product
  const buildVariantPayload = (data) => {
    ...
    return {
      ...
      shippingCost: product.shippingCost ?? 150,
  ...
  useEffect(() => {
    window.__SPAZYO_BUILD_VARIANTS__ = () =>
        ...
        >
          <div className="flex flex-col gap-5 p-6 mb-30">
            ...
            >
              ...
              <p className="text-sm font-medium uppercase ">Crear Variante</p>
            </div>
            ...
            <p className="mb-2 text-sm font-light uppercase truncate text-neutral-600">
              {product?.category}
            </p>
