...
export const InventaryTemplate = ({ setProductState, productState }) => {
  ...
  // Delete handler for variant or product
  ...
  return (
    product && (
      <>
        {isCreateVariantOpen && !isEditVariantOpen && (
          <VariantCreate
            isCreateVariantOpen={isCreateVariantOpen}
            setIsCreateVariantOpen={setIsCreateVariantOpen}
            product={product}
          />
        )}
        {isEditVariantOpen && !isCreateVariantOpen && (
          <EditVariant
            isEditVariantOpen={isEditVariantOpen}
            setIsEditVariantOpen={setIsEditVariantOpen}
            product={product}
        ...
        {!isEditVariantOpen && !isCreateVariantOpen && (
          <div className="flex flex-col gap-5 ">
            <div className="">
              <div className="flex items-center justify-between ">
                ...
                <div className="flex items-center gap-1">
                  <div
                    className="inline-flex items-center p-2 ml-2 border rounded-md cursor-pointer bg-neutral-50 border-black/20 "
                    onClick={() => setIsEditVariantOpen(true)}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="14"
                      ...
                      className="lucide lucide-pencil-icon lucide-pencil text-neutral-800 "
                    >
                  ...
                  >
                    <svg
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      className="lucide lucide-trash-icon lucide-trash text-neutral-800"
                    >
              ...
              <p className="mt-5 mb-2 font-light uppercase truncate text-neutral-600">
                {product.name}
              </p>
            ...
            <div className="flex items-center gap-2">
              {activeVariant && (
                <>
                  ...
                  <p className="text-sm font-light -mt-0.25 uppercase text-neutral-600">
            ...
            <div className="mt-5 border rounded-md border-black/20">
              <div className="grid grid-cols-[1fr_1fr] gap-4 px-3 py-3 text-sm font-light bg-neutral-50 border-b border-black/20 rounded-t-md text-neutral-800 uppercase">
                <p>Talla</p>
              ...
              {activeVariant &&
                Object.entries(activeVariant.sizes ?? {}).map(
                  ([size, quantity]) => (
                    <div
                      key={size}
                      className="grid items-center grid-cols-[1fr_1fr] gap-4 px-3 py-3 text-sm font-light border-b last:border-b-0  border-black/20"
                    >
              ...
              {activeVariant &&
                Object.keys(activeVariant.sizes ?? {}).length === 0 && (
                  <div className="px-3 py-3 text-sm font-light text-neutral-400">
                    Sin stock registrado
                  </div>
                )}
            </div>

            <div className="flex flex-col items-end p-2 font-light border rounded-md bg-neutral-50 border-black/20">
              <p className="text-sm font-light uppercase text-neutral-800">
                Price
              </p>
              <p className="mt-1 text-sm font-light uppercase text-neutral-800">
                $
